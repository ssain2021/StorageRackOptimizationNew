...
#import pandas as pd
from pandas import read_excel as pdRE, errors, DataFrame
from tabulate import tabulate



def read_excel(file_path: str, sheet_name:int=0, header:int=0) -> DataFrame:
    """
...
def print_df(df: DataFrame, rows: int=None, style: str="fancy_grid") -> None:
    """
...
def _read_excel(file_path, sheet_name, header):
    try:
        df = pdRE(file_path, sheet_name, header=header)
        return df
